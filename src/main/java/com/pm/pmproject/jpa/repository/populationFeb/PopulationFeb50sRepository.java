...
import com.pm.pmproject.jpa.domain.populationFeb.PopulationFeb50s;
...
@Repository
public class PopulationFeb50sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationFeb50sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationFeb50s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_feb_50s (admin_code, pop_age_m_50, pop_age_w_50, pop_age_m_51, " +
