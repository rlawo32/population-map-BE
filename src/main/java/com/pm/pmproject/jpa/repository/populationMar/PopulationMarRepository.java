...
@Repository
public class PopulationMarRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationMarRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationResultDto> list) {
        jdbcTemplate.batchUpdate(
                "insert into population_mar (admin_code, standard_date, name_city, " +
    ...
    public void populationTotalInsert(List<PopulationResultDto> list) {
        ...
        //                 "from population_mar", new RowMapper<PopulationResultDto>() {
        //     @Override
        ...
        jdbcTemplate.batchUpdate(
                "insert into population_mar_total (pop_seq, pop_place, pop_total, pop_total_m, pop_total_w) " +
                        "values(?, ?, ?, ?, ?)",
                new BatchPreparedStatementSetter() {
                    @Override
                    public void setValues(PreparedStatement ps, int i) throws SQLException {
