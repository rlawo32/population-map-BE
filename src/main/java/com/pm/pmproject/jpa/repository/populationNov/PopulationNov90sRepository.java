...
import com.pm.pmproject.jpa.domain.populationNov.PopulationNov90s;
...
@Repository
public class PopulationNov90sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationNov90sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationNov90s> list) {
