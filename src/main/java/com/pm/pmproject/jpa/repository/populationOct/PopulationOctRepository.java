...
@Repository
public class PopulationOctRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationOctRepository(JdbcTemplate jdbcTemplate) {
    ...
    public void populationTotalInsert(List<PopulationResultDto> list) {
        ...
        jdbcTemplate.batchUpdate(
                "insert into population_oct_total (pop_seq, pop_place, pop_total, pop_total_m, pop_total_w) " +
                        "values(?, ?, ?, ?, ?)",
                new BatchPreparedStatementSetter() {
                    @Override
                    public void setValues(PreparedStatement ps, int i) throws SQLException {
