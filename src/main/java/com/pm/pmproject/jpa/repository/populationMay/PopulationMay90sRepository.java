...
import com.pm.pmproject.jpa.domain.populationMay.PopulationMay90s;
...
@Repository
public class PopulationMay90sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationMay90sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationMay90s> list) {
