...
import com.pm.pmproject.jpa.domain.populationJun.PopulationJun70s;
...
@Repository
public class PopulationJun70sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJun70sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJun70s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jun_70s (admin_code, pop_age_m_70, pop_age_w_70, pop_age_m_71, " +
