...
import com.pm.pmproject.jpa.domain.populationMay.PopulationMay80s;
...
public class PopulationMay80sRepository {
    ...
    public void batchInsert(List<PopulationMay80s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_may_80s (admin_code, pop_age_m_80, pop_age_w_80, pop_age_m_81, " +
