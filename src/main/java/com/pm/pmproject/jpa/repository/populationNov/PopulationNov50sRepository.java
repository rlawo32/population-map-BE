...
import com.pm.pmproject.jpa.domain.populationNov.PopulationNov50s;
...
@Repository
public class PopulationNov50sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationNov50sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationNov50s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_nov_50s (admin_code, pop_age_m_50, pop_age_w_50, pop_age_m_51, " +
