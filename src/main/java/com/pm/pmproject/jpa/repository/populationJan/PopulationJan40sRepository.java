...
@Repository
public class PopulationJan40sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJan40sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<Population40sDto> list) {
        jdbcTemplate.batchUpdate(
                "insert into population_jan_40s (admin_code, age_40_m, age_40_w, " +
    ...
    public void populationTotalInsert(List<Population40sDto> list) {
        ...
        jdbcTemplate.batchUpdate(
                "insert into population_jan_total_40s (pop_seq, pop_place, " +
