...
import com.pm.pmproject.jpa.domain.populationAug.PopulationAug100s;
...
public class PopulationAug100sRepository {
    ...
    public void batchInsert(List<PopulationAug100s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_aug_100s (admin_code, pop_age_m_100, pop_age_w_100, pop_age_m_101, " +
