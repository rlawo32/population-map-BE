...
import com.pm.pmproject.jpa.domain.populationJun.PopulationJun30s;
...
@Repository
public class PopulationJun30sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJun30sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJun30s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jun_30s (admin_code, pop_age_m_30, pop_age_w_30, pop_age_m_31, " +
