...
import com.pm.pmproject.jpa.domain.populationMay.PopulationMay100s;
...
@Repository
public class PopulationMay100sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationMay100sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationMay100s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_may_100s (admin_code, pop_age_m_100, pop_age_w_100, pop_age_m_101, " +
