...
import com.pm.pmproject.jpa.domain.populationNov.PopulationNov40s;
...
@Repository
public class PopulationNov40sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationNov40sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationNov40s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_nov_40s (admin_code, pop_age_m_40, pop_age_w_40, pop_age_m_41, " +
