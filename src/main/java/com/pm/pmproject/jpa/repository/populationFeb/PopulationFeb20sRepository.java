...
import com.pm.pmproject.jpa.domain.populationFeb.PopulationFeb20s;
...
@Repository
public class PopulationFeb20sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationFeb20sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationFeb20s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_feb_20s (admin_code, pop_age_m_20, pop_age_w_20, pop_age_m_21, " +
