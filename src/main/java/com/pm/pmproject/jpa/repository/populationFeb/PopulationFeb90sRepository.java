...
import com.pm.pmproject.jpa.domain.populationFeb.PopulationFeb90s;
...
@Repository
public class PopulationFeb90sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationFeb90sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationFeb90s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_feb_90s (admin_code, pop_age_m_90, pop_age_w_90, pop_age_m_91, " +
