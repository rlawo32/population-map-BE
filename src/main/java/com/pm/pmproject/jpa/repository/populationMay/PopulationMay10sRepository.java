...
import com.pm.pmproject.jpa.domain.populationMay.PopulationMay10s;
...
@Repository
public class PopulationMay10sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationMay10sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationMay10s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_may_10s (admin_code, pop_age_m_10, pop_age_w_10, pop_age_m_11, " +
