...
import com.pm.pmproject.jpa.domain.populationMar.PopulationMar40s;
...
@Repository
public class PopulationMar40sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationMar40sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationMar40s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_mar_40s (admin_code, pop_age_m_40, pop_age_w_40, pop_age_m_41, " +
