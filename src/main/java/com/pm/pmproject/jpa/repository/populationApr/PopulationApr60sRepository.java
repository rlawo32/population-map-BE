...
import com.pm.pmproject.jpa.domain.populationApr.PopulationApr60s;
...
@Repository
public class PopulationApr60sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationApr60sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationApr60s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_apr_60s (admin_code, pop_age_m_60, pop_age_w_60, pop_age_m_61, " +
