...
import com.pm.pmproject.jpa.domain.populationApr.PopulationApr90s;
...
public class PopulationApr90sRepository {
    ...
    public void batchInsert(List<PopulationApr90s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_apr_90s (admin_code, pop_age_m_90, pop_age_w_90, pop_age_m_91, " +
