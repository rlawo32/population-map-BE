...
import com.pm.pmproject.jpa.domain.populationSep.PopulationSep40s;
...
public class PopulationSep40sRepository {
    ...
    public void batchInsert(List<PopulationSep40s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_sep_40s (admin_code, pop_age_m_40, pop_age_w_40, pop_age_m_41, " +
