...
import com.pm.pmproject.jpa.domain.populationDec.PopulationDec50s;
...
@Repository
public class PopulationDec50sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationDec50sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationDec50s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_dec_50s (admin_code, pop_age_m_50, pop_age_w_50, pop_age_m_51, " +
