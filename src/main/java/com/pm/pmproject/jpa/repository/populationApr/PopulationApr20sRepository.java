...
public class PopulationApr20sRepository {
    ...
    public void batchInsert(List<Population20sDto> list) {
        jdbcTemplate.batchUpdate(
                "insert into population_apr_20s (admin_code, age_20_m, age_20_w, " +
    ...
    public void populationTotalInsert(List<Population20sDto> list) {
        ...
        //                 "from population_apr", new RowMapper<PopulationResultDto>() {
        //     @Override
        ...
        jdbcTemplate.batchUpdate(
                "insert into population_apr_total_20s (pop_seq, pop_place, " +
