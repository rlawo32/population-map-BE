...
import com.pm.pmproject.jpa.domain.populationApr.PopulationApr20s;
...
@Repository
public class PopulationApr20sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationApr20sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationApr20s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_apr_20s (admin_code, pop_age_m_20, pop_age_w_20, pop_age_m_21, " +
