...
import com.pm.pmproject.jpa.domain.populationNov.PopulationNov20s;
...
@Repository
public class PopulationNov20sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationNov20sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationNov20s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_nov_20s (admin_code, pop_age_m_20, pop_age_w_20, pop_age_m_21, " +
