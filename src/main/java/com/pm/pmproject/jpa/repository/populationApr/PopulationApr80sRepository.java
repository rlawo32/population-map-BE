...
import com.pm.pmproject.jpa.domain.populationApr.PopulationApr80s;
...
@Repository
public class PopulationApr80sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationApr80sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationApr80s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_apr_80s (admin_code, pop_age_m_80, pop_age_w_80, pop_age_m_81, " +
