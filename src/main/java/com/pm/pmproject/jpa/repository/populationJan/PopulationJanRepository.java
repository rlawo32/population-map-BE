...
@Repository
public class PopulationJanRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJanRepository(JdbcTemplate jdbcTemplate) {
    ...
    public void populationTotalInsert(List<PopulationResultDto> list) {
        ...
        jdbcTemplate.batchUpdate(
                "insert into population_jan_total (pop_seq, pop_place, pop_total, pop_total_m, pop_total_w) " +
                        "values(?, ?, ?, ?, ?)",
                new BatchPreparedStatementSetter() {
                    @Override
                    public void setValues(PreparedStatement ps, int i) throws SQLException {
