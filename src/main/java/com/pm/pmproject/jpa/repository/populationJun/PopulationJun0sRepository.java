...
import com.pm.pmproject.jpa.domain.populationJun.PopulationJun0s;
...
@Repository
public class PopulationJun0sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJun0sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJun0s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jun_0s (admin_code, pop_age_m_0, pop_age_w_0, pop_age_m_1, " +
