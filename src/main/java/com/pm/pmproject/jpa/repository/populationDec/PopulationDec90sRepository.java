...
import com.pm.pmproject.jpa.domain.populationDec.PopulationDec90s;
...
@Repository
public class PopulationDec90sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationDec90sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationDec90s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_dec_90s (admin_code, pop_age_m_90, pop_age_w_90, pop_age_m_91, " +
