...
import com.pm.pmproject.jpa.domain.populationDec.PopulationDec20s;
...
@Repository
public class PopulationDec20sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationDec20sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationDec20s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_dec_20s (admin_code, pop_age_m_20, pop_age_w_20, pop_age_m_21, " +
