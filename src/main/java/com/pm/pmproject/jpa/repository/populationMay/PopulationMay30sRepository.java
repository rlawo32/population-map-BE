...
import com.pm.pmproject.jpa.domain.populationMay.PopulationMay30s;
...
@Repository
public class PopulationMay30sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationMay30sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationMay30s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_may_30s (admin_code, pop_age_m_30, pop_age_w_30, pop_age_m_31, " +
