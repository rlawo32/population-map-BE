...
import com.pm.pmproject.jpa.domain.populationFeb.PopulationFeb40s;
...
@Repository
public class PopulationFeb40sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationFeb40sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationFeb40s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_feb_40s (admin_code, pop_age_m_40, pop_age_w_40, pop_age_m_41, " +
