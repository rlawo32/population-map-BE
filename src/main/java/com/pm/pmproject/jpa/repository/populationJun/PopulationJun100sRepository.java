...
import com.pm.pmproject.jpa.domain.populationJun.PopulationJun100s;
...
@Repository
public class PopulationJun100sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJun100sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJun100s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jun_100s (admin_code, pop_age_m_100, pop_age_w_100, pop_age_m_101, " +
