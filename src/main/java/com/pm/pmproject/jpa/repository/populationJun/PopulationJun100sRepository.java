...
public class PopulationJun100sRepository {
    ...
    public void batchInsert(List<Population100sDto> list) {
        jdbcTemplate.batchUpdate(
                "insert into population_jun_100s (admin_code, age_100_m, age_100_w, " +
    ...
    public void populationTotalInsert(List<Population100sDto> list) {
        ...
        //                 "from population_jun", new RowMapper<PopulationResultDto>() {
        //     @Override
        ...
        jdbcTemplate.batchUpdate(
                "insert into population_jun_total_100s (pop_seq, pop_place, " +
