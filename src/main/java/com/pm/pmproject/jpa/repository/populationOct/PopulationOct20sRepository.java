...
import com.pm.pmproject.jpa.domain.populationOct.PopulationOct20s;
...
@Repository
public class PopulationOct20sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationOct20sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationOct20s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_oct_20s (admin_code, pop_age_m_20, pop_age_w_20, pop_age_m_21, " +
