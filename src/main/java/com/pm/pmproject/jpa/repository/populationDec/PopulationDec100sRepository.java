...
import com.pm.pmproject.jpa.domain.populationDec.PopulationDec100s;
...
public class PopulationDec100sRepository {
    ...
    public void batchInsert(List<PopulationDec100s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_dec_100s (admin_code, pop_age_m_100, pop_age_w_100, pop_age_m_101, " +
