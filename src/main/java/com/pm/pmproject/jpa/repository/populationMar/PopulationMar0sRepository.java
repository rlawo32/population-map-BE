...
import com.pm.pmproject.jpa.domain.populationMar.PopulationMar0s;
...
@Repository
public class PopulationMar0sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationMar0sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationMar0s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_mar_0s (admin_code, pop_age_m_0, pop_age_w_0, pop_age_m_1, " +
