...
import com.pm.pmproject.jpa.domain.populationDec.PopulationDec40s;
...
@Repository
public class PopulationDec40sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationDec40sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationDec40s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_dec_40s (admin_code, pop_age_m_40, pop_age_w_40, pop_age_m_41, " +
