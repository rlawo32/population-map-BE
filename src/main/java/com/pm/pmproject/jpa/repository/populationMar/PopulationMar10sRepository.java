...
import com.pm.pmproject.jpa.domain.populationMar.PopulationMar10s;
...
@Repository
public class PopulationMar10sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationMar10sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationMar10s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_mar_10s (admin_code, pop_age_m_10, pop_age_w_10, pop_age_m_11, " +
