...
import com.pm.pmproject.jpa.domain.populationJul.PopulationJul20s;
...
@Repository
public class PopulationJul20sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJul20sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJul20s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jul_20s (admin_code, pop_age_m_20, pop_age_w_20, pop_age_m_21, " +
