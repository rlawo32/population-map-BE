...
import com.pm.pmproject.jpa.domain.populationMar.PopulationMar20s;
...
@Repository
public class PopulationMar20sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationMar20sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationMar20s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_mar_20s (admin_code, pop_age_m_20, pop_age_w_20, pop_age_m_21, " +
