...
import com.pm.pmproject.jpa.domain.populationJun.PopulationJun90s;
...
@Repository
public class PopulationJun90sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJun90sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJun90s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jun_90s (admin_code, pop_age_m_90, pop_age_w_90, pop_age_m_91, " +
