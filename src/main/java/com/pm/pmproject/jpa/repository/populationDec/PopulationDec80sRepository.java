...
import com.pm.pmproject.jpa.domain.populationDec.PopulationDec80s;
...
@Repository
public class PopulationDec80sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationDec80sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationDec80s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_dec_80s (admin_code, pop_age_m_80, pop_age_w_80, pop_age_m_81, " +
