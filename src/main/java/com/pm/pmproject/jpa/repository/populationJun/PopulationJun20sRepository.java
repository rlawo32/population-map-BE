...
import com.pm.pmproject.jpa.domain.populationJun.PopulationJun20s;
...
public class PopulationJun20sRepository {
    ...
    public void batchInsert(List<PopulationJun20s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jun_20s (admin_code, pop_age_m_20, pop_age_w_20, pop_age_m_21, " +
