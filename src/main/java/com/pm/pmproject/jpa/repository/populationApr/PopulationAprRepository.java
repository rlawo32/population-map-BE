...
@Repository
public class PopulationAprRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationAprRepository(JdbcTemplate jdbcTemplate) {
    ...
    public void populationTotalInsert(List<PopulationResultDto> list) {
        ...
        jdbcTemplate.batchUpdate(
                "insert into population_apr_total (pop_seq, pop_place, pop_total, pop_total_m, pop_total_w) " +
                        "values(?, ?, ?, ?, ?)",
                new BatchPreparedStatementSetter() {
                    @Override
                    public void setValues(PreparedStatement ps, int i) throws SQLException {
