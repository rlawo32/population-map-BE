...
import com.pm.pmproject.jpa.domain.populationJul.PopulationJul70s;
...
@Repository
public class PopulationJul70sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJul70sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJul70s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jul_70s (admin_code, pop_age_m_70, pop_age_w_70, pop_age_m_71, " +
