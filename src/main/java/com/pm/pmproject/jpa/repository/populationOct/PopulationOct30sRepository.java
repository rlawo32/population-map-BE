...
import com.pm.pmproject.jpa.domain.populationOct.PopulationOct30s;
...
public class PopulationOct30sRepository {
    ...
    public void batchInsert(List<PopulationOct30s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_oct_30s (admin_code, pop_age_m_30, pop_age_w_30, pop_age_m_31, " +
