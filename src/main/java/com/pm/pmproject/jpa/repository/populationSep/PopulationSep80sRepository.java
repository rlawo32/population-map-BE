...
@Repository
public class PopulationSep80sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationSep80sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationSep80s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_sep_80s (admin_code, pop_age_m_80, pop_age_w_80, pop_age_m_81, " +
