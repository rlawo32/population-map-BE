...
import com.pm.pmproject.jpa.domain.populationSep.PopulationSep70s;
...
@Repository
public class PopulationSep70sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationSep70sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationSep70s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_sep_70s (admin_code, pop_age_m_70, pop_age_w_70, pop_age_m_71, " +
