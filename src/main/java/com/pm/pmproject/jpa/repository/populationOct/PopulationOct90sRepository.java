...
import com.pm.pmproject.jpa.domain.populationOct.PopulationOct90s;
...
@Repository
public class PopulationOct90sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationOct90sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationOct90s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_oct_90s (admin_code, pop_age_m_90, pop_age_w_90, pop_age_m_91, " +
