...
import com.pm.pmproject.jpa.domain.populationFeb.PopulationFeb10s;
...
@Repository
public class PopulationFeb10sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationFeb10sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationFeb10s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_feb_10s (admin_code, pop_age_m_10, pop_age_w_10, pop_age_m_11, " +
