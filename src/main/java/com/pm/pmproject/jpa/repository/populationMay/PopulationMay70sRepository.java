...
import com.pm.pmproject.jpa.domain.populationMay.PopulationMay70s;
...
public class PopulationMay70sRepository {
    ...
    public void batchInsert(List<PopulationMay70s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_may_70s (admin_code, pop_age_m_70, pop_age_w_70, pop_age_m_71, " +
