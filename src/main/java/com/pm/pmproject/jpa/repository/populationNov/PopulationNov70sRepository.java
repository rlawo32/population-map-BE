...
import com.pm.pmproject.jpa.domain.populationNov.PopulationNov70s;
...
@Repository
public class PopulationNov70sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationNov70sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationNov70s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_nov_70s (admin_code, pop_age_m_70, pop_age_w_70, pop_age_m_71, " +
