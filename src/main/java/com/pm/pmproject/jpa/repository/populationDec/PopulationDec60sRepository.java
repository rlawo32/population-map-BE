...
import com.pm.pmproject.jpa.domain.populationDec.PopulationDec60s;
...
public class PopulationDec60sRepository {
    ...
    public void batchInsert(List<PopulationDec60s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_dec_60s (admin_code, pop_age_m_60, pop_age_w_60, pop_age_m_61, " +
