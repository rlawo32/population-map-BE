...
@Repository
public class PopulationJul50sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJul50sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJul50s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jul_50s (admin_code, pop_age_m_50, pop_age_w_50, pop_age_m_51, " +
