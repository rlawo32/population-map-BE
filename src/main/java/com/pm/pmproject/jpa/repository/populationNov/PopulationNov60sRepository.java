...
import com.pm.pmproject.jpa.domain.populationNov.PopulationNov60s;
...
public class PopulationNov60sRepository {
    ...
    public void batchInsert(List<PopulationNov60s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_nov_60s (admin_code, pop_age_m_60, pop_age_w_60, pop_age_m_61, " +
