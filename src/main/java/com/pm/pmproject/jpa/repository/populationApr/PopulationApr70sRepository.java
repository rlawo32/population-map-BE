...
import com.pm.pmproject.jpa.domain.populationApr.PopulationApr70s;
...
@Repository
public class PopulationApr70sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationApr70sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationApr70s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_apr_70s (admin_code, pop_age_m_70, pop_age_w_70, pop_age_m_71, " +
