...
import com.pm.pmproject.jpa.domain.populationJul.PopulationJul100s;
...
@Repository
public class PopulationJul100sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJul100sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJul100s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jul_100s (admin_code, pop_age_m_100, pop_age_w_100, pop_age_m_101, " +
