...
@Repository
public class PopulationJan60sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJan60sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<Population60sDto> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jan_60s (admin_code, pop_age_m_60, pop_age_w_60, pop_age_m_61, " +
                ...
                new BatchPreparedStatementSetter() {
                    ...
                    public void setValues(PreparedStatement ps, int i) throws SQLException {
                        Long mTotal = list.get(i).getPopAgeM60() + list.get(i).getPopAgeM61() + list.get(i).getPopAgeM62() +
                        ...
                        Long wTotal = list.get(i).getPopAgeW60() + list.get(i).getPopAgeW61() + list.get(i).getPopAgeW62() +
