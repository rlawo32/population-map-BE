...
import com.pm.pmproject.jpa.domain.populationJul.PopulationJul30s;
...
@Repository
public class PopulationJul30sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJul30sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJul30s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jul_30s (admin_code, pop_age_m_30, pop_age_w_30, pop_age_m_31, " +
