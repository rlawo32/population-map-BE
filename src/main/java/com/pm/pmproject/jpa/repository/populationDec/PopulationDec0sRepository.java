...
import com.pm.pmproject.jpa.domain.populationDec.PopulationDec0s;
...
@Repository
public class PopulationDec0sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationDec0sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationDec0s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_dec_0s (admin_code, pop_age_m_0, pop_age_w_0, pop_age_m_1, " +
