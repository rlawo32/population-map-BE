...
import com.pm.pmproject.jpa.domain.populationJul.PopulationJul80s;
...
@Repository
public class PopulationJul80sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJul80sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJul80s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jul_80s (admin_code, pop_age_m_80, pop_age_w_80, pop_age_m_81, " +
