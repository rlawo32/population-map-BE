...
import com.pm.pmproject.jpa.domain.populationMar.PopulationMar70s;
...
@Repository
public class PopulationMar70sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationMar70sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationMar70s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_mar_70s (admin_code, pop_age_m_70, pop_age_w_70, pop_age_m_71, " +
