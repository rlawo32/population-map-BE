...
import com.pm.pmproject.jpa.domain.populationAug.PopulationAug10s;
...
@Repository
public class PopulationAug10sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationAug10sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationAug10s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_aug_10s (admin_code, pop_age_m_10, pop_age_w_10, pop_age_m_11, " +
