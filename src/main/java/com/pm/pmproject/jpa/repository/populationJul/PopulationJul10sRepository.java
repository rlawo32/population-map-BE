...
import com.pm.pmproject.jpa.domain.populationJul.PopulationJul10s;
...
@Repository
public class PopulationJul10sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJul10sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJul10s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jul_10s (admin_code, pop_age_m_10, pop_age_w_10, pop_age_m_11, " +
