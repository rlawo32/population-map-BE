...
import com.pm.pmproject.jpa.domain.populationJun.PopulationJun80s;
...
@Repository
public class PopulationJun80sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJun80sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJun80s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jun_80s (admin_code, pop_age_m_80, pop_age_w_80, pop_age_m_81, " +
