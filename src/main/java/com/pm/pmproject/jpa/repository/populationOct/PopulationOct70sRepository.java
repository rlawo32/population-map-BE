...
@Repository
public class PopulationOct70sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationOct70sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<Population70sDto> list) {
        jdbcTemplate.batchUpdate(
                "insert into population_oct_70s (admin_code, age_70_m, age_70_w, " +
    ...
    public void populationTotalInsert(List<Population70sDto> list) {
        ...
        jdbcTemplate.batchUpdate(
                "insert into population_oct_total_70s (pop_seq, pop_place, " +
