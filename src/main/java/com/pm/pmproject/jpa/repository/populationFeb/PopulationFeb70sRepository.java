...
import com.pm.pmproject.jpa.domain.populationFeb.PopulationFeb70s;
...
@Repository
public class PopulationFeb70sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationFeb70sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationFeb70s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_feb_70s (admin_code, pop_age_m_70, pop_age_w_70, pop_age_m_71, " +
