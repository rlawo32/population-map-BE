...
import com.pm.pmproject.jpa.domain.populationMar.PopulationMar100s;
...
@Repository
public class PopulationMar100sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationMar100sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationMar100s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_mar_100s (admin_code, pop_age_m_100, pop_age_w_100, pop_age_m_101, " +
