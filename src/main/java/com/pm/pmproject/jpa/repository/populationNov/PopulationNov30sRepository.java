...
import com.pm.pmproject.jpa.domain.populationNov.PopulationNov30s;
...
@Repository
public class PopulationNov30sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationNov30sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationNov30s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_nov_30s (admin_code, pop_age_m_30, pop_age_w_30, pop_age_m_31, " +
