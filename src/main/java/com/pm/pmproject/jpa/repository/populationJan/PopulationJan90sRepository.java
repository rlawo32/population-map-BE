...
import com.pm.pmproject.jpa.domain.populationJan.PopulationJan90s;
...
@Repository
public class PopulationJan90sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJan90sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJan90s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jan_90s (admin_code, pop_age_m_90, pop_age_w_90, pop_age_m_91, " +
