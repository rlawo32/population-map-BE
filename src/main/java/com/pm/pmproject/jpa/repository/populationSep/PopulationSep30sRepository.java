...
import com.pm.pmproject.jpa.domain.populationSep.PopulationSep30s;
...
@Repository
public class PopulationSep30sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationSep30sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationSep30s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_sep_30s (admin_code, pop_age_m_30, pop_age_w_30, pop_age_m_31, " +
