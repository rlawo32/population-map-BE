...
import com.pm.pmproject.jpa.domain.populationAug.PopulationAug70s;
...
public class PopulationAug70sRepository {
    ...
    public void batchInsert(List<PopulationAug70s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_aug_70s (admin_code, pop_age_m_70, pop_age_w_70, pop_age_m_71, " +
