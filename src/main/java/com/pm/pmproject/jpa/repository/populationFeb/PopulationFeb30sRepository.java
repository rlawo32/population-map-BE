...
import com.pm.pmproject.jpa.domain.populationFeb.PopulationFeb30s;
...
@Repository
public class PopulationFeb30sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationFeb30sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationFeb30s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_feb_30s (admin_code, pop_age_m_30, pop_age_w_30, pop_age_m_31, " +
