...
import com.pm.pmproject.jpa.domain.populationJul.PopulationJul60s;
...
@Repository
public class PopulationJul60sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJul60sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJul60s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jul_60s (admin_code, pop_age_m_60, pop_age_w_60, pop_age_m_61, " +
