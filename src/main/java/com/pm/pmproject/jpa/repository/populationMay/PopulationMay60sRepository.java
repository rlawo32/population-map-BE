...
import com.pm.pmproject.jpa.domain.populationMay.PopulationMay60s;
...
@Repository
public class PopulationMay60sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationMay60sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationMay60s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_may_60s (admin_code, pop_age_m_60, pop_age_w_60, pop_age_m_61, " +
