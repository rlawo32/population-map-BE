...
import com.pm.pmproject.jpa.domain.populationSep.PopulationSep50s;
...
@Repository
public class PopulationSep50sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationSep50sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationSep50s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_sep_50s (admin_code, pop_age_m_50, pop_age_w_50, pop_age_m_51, " +
