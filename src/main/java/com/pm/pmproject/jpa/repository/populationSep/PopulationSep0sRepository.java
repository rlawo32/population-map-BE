...
import com.pm.pmproject.jpa.domain.populationSep.PopulationSep0s;
...
@Repository
public class PopulationSep0sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationSep0sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationSep0s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_sep_0s (admin_code, pop_age_m_0, pop_age_w_0, pop_age_m_1, " +
