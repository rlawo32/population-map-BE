...
import com.pm.pmproject.jpa.domain.populationApr.PopulationApr50s;
...
@Repository
public class PopulationApr50sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationApr50sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationApr50s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_apr_50s (admin_code, pop_age_m_50, pop_age_w_50, pop_age_m_51, " +
