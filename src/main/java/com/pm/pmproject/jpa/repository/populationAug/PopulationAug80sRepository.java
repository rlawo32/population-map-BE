...
import com.pm.pmproject.jpa.domain.populationAug.PopulationAug80s;
...
@Repository
public class PopulationAug80sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationAug80sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationAug80s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_aug_80s (admin_code, pop_age_m_80, pop_age_w_80, pop_age_m_81, " +
