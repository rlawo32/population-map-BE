...
import com.pm.pmproject.jpa.domain.populationAug.PopulationAug30s;
...
@Repository
public class PopulationAug30sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationAug30sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationAug30s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_aug_30s (admin_code, pop_age_m_30, pop_age_w_30, pop_age_m_31, " +
