...
import com.pm.pmproject.jpa.domain.populationDec.PopulationDec30s;
...
@Repository
public class PopulationDec30sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationDec30sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationDec30s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_dec_30s (admin_code, pop_age_m_30, pop_age_w_30, pop_age_m_31, " +
