...
import com.pm.pmproject.jpa.domain.populationJun.PopulationJun50s;
...
@Repository
public class PopulationJun50sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJun50sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJun50s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jun_50s (admin_code, pop_age_m_50, pop_age_w_50, pop_age_m_51, " +
