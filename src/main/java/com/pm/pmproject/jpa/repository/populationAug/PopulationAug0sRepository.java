...
import com.pm.pmproject.jpa.domain.populationAug.PopulationAug0s;
...
public class PopulationAug0sRepository {
    ...
    public void batchInsert(List<PopulationAug0s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_aug_0s (admin_code, pop_age_m_0, pop_age_w_0, pop_age_m_1, " +
