...
@Repository
public class PopulationJulRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJulRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationResultDto> list) {
        jdbcTemplate.batchUpdate(
                "insert into population_jul (admin_code, standard_date, name_city, " +
    ...
    public void populationTotalInsert(List<PopulationResultDto> list) {
        ...
        //                 "from population_jul", new RowMapper<PopulationResultDto>() {
        //     @Override
        ...
        jdbcTemplate.batchUpdate(
                "insert into population_jul_total (pop_seq, pop_place, pop_total, pop_total_m, pop_total_w) " +
                        "values(?, ?, ?, ?, ?)",
                new BatchPreparedStatementSetter() {
                    @Override
                    public void setValues(PreparedStatement ps, int i) throws SQLException {
