...
import com.pm.pmproject.jpa.domain.populationMar.PopulationMar90s;
...
@Repository
public class PopulationMar90sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationMar90sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationMar90s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_mar_90s (admin_code, pop_age_m_90, pop_age_w_90, pop_age_m_91, " +
