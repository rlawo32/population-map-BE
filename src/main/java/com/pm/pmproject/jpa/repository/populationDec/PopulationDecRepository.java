...
import com.pm.pmproject.jpa.domain.populationDec.PopulationDec;
...
@Repository
public class PopulationDecRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationDecRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationDec> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_dec (admin_code, standard_date, name_city, " +
