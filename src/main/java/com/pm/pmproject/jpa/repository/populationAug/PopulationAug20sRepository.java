...
import com.pm.pmproject.jpa.domain.populationAug.PopulationAug20s;
...
@Repository
public class PopulationAug20sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationAug20sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationAug20s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_aug_20s (admin_code, pop_age_m_20, pop_age_w_20, pop_age_m_21, " +
