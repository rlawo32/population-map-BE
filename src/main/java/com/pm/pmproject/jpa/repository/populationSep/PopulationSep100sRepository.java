...
import com.pm.pmproject.jpa.domain.populationSep.PopulationSep100s;
...
@Repository
public class PopulationSep100sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationSep100sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationSep100s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_sep_100s (admin_code, pop_age_m_100, pop_age_w_100, pop_age_m_101, " +
