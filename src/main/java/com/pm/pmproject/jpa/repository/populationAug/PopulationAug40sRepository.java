...
import com.pm.pmproject.jpa.domain.populationAug.PopulationAug40s;
...
@Repository
public class PopulationAug40sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationAug40sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationAug40s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_aug_40s (admin_code, pop_age_m_40, pop_age_w_40, pop_age_m_41, " +
