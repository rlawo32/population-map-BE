...
import com.pm.pmproject.jpa.domain.populationMay.PopulationMay50s;
...
public class PopulationMay50sRepository {
    ...
    public void batchInsert(List<PopulationMay50s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_may_50s (admin_code, pop_age_m_50, pop_age_w_50, pop_age_m_51, " +
