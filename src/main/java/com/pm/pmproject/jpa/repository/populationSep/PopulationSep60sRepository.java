...
import com.pm.pmproject.jpa.domain.populationSep.PopulationSep60s;
...
@Repository
public class PopulationSep60sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationSep60sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationSep60s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_sep_60s (admin_code, pop_age_m_60, pop_age_w_60, pop_age_m_61, " +
