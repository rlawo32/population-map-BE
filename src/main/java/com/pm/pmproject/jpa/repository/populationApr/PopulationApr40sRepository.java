...
import com.pm.pmproject.jpa.domain.populationApr.PopulationApr40s;
...
@Repository
public class PopulationApr40sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationApr40sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationApr40s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_apr_40s (admin_code, pop_age_m_40, pop_age_w_40, pop_age_m_41, " +
