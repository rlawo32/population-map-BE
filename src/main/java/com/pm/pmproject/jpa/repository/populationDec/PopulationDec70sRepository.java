...
import com.pm.pmproject.jpa.domain.populationDec.PopulationDec70s;
...
@Repository
public class PopulationDec70sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationDec70sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationDec70s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_dec_70s (admin_code, pop_age_m_70, pop_age_w_70, pop_age_m_71, " +
