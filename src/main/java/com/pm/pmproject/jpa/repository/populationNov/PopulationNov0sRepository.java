...
import com.pm.pmproject.jpa.domain.populationNov.PopulationNov0s;
...
@Repository
public class PopulationNov0sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationNov0sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationNov0s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_nov_0s (admin_code, pop_age_m_0, pop_age_w_0, pop_age_m_1, " +
