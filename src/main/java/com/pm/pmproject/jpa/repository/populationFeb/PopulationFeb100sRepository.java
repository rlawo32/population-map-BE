...
import com.pm.pmproject.jpa.domain.populationFeb.PopulationFeb100s;
...
@Repository
public class PopulationFeb100sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationFeb100sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationFeb100s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_feb_100s (admin_code, pop_age_m_100, pop_age_w_100, pop_age_m_101, " +
