...
import com.pm.pmproject.jpa.domain.populationMay.PopulationMay40s;
...
public class PopulationMay40sRepository {
    ...
    public void batchInsert(List<PopulationMay40s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_may_40s (admin_code, pop_age_m_40, pop_age_w_40, pop_age_m_41, " +
