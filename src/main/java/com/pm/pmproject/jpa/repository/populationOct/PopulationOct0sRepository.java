...
import com.pm.pmproject.jpa.domain.populationOct.PopulationOct0s;
...
public class PopulationOct0sRepository {
    ...
    public void batchInsert(List<PopulationOct0s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_oct_0s (admin_code, pop_age_m_0, pop_age_w_0, pop_age_m_1, " +
