...
import com.pm.pmproject.jpa.domain.populationJul.PopulationJul0s;
...
@Repository
public class PopulationJul0sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationJul0sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationJul0s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_jul_0s (admin_code, pop_age_m_0, pop_age_w_0, pop_age_m_1, " +
