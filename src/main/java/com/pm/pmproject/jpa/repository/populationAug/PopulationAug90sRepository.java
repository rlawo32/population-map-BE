...
import com.pm.pmproject.jpa.domain.populationAug.PopulationAug90s;
...
public class PopulationAug90sRepository {
    ...
    public void batchInsert(List<PopulationAug90s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_aug_90s (admin_code, pop_age_m_90, pop_age_w_90, pop_age_m_91, " +
