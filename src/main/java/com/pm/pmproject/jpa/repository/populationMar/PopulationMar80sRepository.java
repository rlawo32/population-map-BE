...
import com.pm.pmproject.jpa.domain.populationMar.PopulationMar80s;
...
@Repository
public class PopulationMar80sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationMar80sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationMar80s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_mar_80s (admin_code, pop_age_m_80, pop_age_w_80, pop_age_m_81, " +
