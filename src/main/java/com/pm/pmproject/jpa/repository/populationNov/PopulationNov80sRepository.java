...
import com.pm.pmproject.jpa.domain.populationNov.PopulationNov80s;
...
@Repository
public class PopulationNov80sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationNov80sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationNov80s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_nov_80s (admin_code, pop_age_m_80, pop_age_w_80, pop_age_m_81, " +
