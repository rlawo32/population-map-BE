...
import com.pm.pmproject.jpa.domain.populationNov.PopulationNov10s;
...
@Repository
public class PopulationNov10sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationNov10sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationNov10s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_nov_10s (admin_code, pop_age_m_10, pop_age_w_10, pop_age_m_11, " +
