...
import com.pm.pmproject.jpa.domain.populationApr.PopulationApr0s;
...
@Repository
public class PopulationApr0sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationApr0sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationApr0s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_apr_0s (admin_code, pop_age_m_0, pop_age_w_0, pop_age_m_1, " +
