...
import com.pm.pmproject.jpa.domain.populationAug.PopulationAug60s;
...
@Repository
public class PopulationAug60sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationAug60sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationAug60s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_aug_60s (admin_code, pop_age_m_60, pop_age_w_60, pop_age_m_61, " +
