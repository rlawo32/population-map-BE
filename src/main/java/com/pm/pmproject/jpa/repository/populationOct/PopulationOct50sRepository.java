...
import com.pm.pmproject.jpa.domain.populationOct.PopulationOct50s;
...
@Repository
public class PopulationOct50sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationOct50sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationOct50s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_oct_50s (admin_code, pop_age_m_50, pop_age_w_50, pop_age_m_51, " +
