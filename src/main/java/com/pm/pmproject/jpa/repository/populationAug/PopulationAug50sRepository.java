...
import com.pm.pmproject.jpa.domain.populationAug.PopulationAug50s;
import com.pm.pmproject.jpa.domain.populationJul.PopulationJul50s;
...
@Repository
public class PopulationAug50sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationAug50sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationAug50s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_aug_50s (admin_code, pop_age_m_50, pop_age_w_50, pop_age_m_51, " +
