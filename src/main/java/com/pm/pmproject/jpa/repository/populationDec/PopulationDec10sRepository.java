...
import com.pm.pmproject.jpa.domain.populationDec.PopulationDec10s;
...
public class PopulationDec10sRepository {
    ...
    public void batchInsert(List<PopulationDec10s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_dec_10s (admin_code, pop_age_m_10, pop_age_w_10, pop_age_m_11, " +
