...
import com.pm.pmproject.jpa.domain.populationApr.PopulationApr10s;
...
@Repository
public class PopulationApr10sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationApr10sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationApr10s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_apr_10s (admin_code, pop_age_m_10, pop_age_w_10, pop_age_m_11, " +
