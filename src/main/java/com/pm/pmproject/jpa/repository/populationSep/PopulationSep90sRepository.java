...
import com.pm.pmproject.jpa.domain.populationSep.PopulationSep90s;
...
@Repository
public class PopulationSep90sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationSep90sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationSep90s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_sep_90s (admin_code, pop_age_m_90, pop_age_w_90, pop_age_m_91, " +
