...
import com.pm.pmproject.jpa.domain.populationOct.PopulationOct40s;
...
@Repository
public class PopulationOct40sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationOct40sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationOct40s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_oct_40s (admin_code, pop_age_m_40, pop_age_w_40, pop_age_m_41, " +
