...
import com.pm.pmproject.jpa.domain.populationFeb.PopulationFeb60s;
...
@Repository
public class PopulationFeb60sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationFeb60sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationFeb60s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_feb_60s (admin_code, pop_age_m_60, pop_age_w_60, pop_age_m_61, " +
