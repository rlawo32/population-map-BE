...
import com.pm.pmproject.jpa.domain.populationOct.PopulationOct10s;
...
@Repository
public class PopulationOct10sRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationOct10sRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationOct10s> list) {
        jdbcTemplate.batchUpdate(
                "INSERT INTO population_oct_10s (admin_code, pop_age_m_10, pop_age_w_10, pop_age_m_11, " +
