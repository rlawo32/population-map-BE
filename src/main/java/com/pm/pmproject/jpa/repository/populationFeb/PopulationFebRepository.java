...
@Repository
public class PopulationFebRepository {

    private final JdbcTemplate jdbcTemplate;

    public PopulationFebRepository(JdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    public void batchInsert(List<PopulationResultDto> list) {
        jdbcTemplate.batchUpdate(
                "insert into population_feb (admin_code, standard_date, name_city, " +
    ...
    public void populationTotalInsert(List<PopulationResultDto> list) {
        ...
        //                 "from population_feb", new RowMapper<PopulationResultDto>() {
        //     @Override
        ...
        jdbcTemplate.batchUpdate(
                "insert into population_feb_total (pop_seq, pop_place, pop_total, pop_total_m, pop_total_w) " +
                        "values(?, ?, ?, ?, ?)",
                new BatchPreparedStatementSetter() {
                    @Override
                    public void setValues(PreparedStatement ps, int i) throws SQLException {
